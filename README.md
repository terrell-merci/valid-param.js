...
If parameter can be of any type, including `null`, programmer may use the `mixed` or `any` types. Either will allow any value through, regardless of type, as long as the parameter is defined.
```js
	{
		age: 'mixed',
	}
